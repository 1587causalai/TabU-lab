...
from tabu_lab.experiments import run_query_row_openml_full_context  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_query_row_openml_full_context(
    ...
    compact = {
        ...
        "context_rows_by_dataset_split": result["context_rows_by_dataset_split"],
